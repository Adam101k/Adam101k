...
- Working with **C++**, **Blueprints**, and multiplayer networking systems
- Managing weekly development workflows, task planning, code review, and team communication
- Exploring underwater rendering, stylized visuals, and immersive co-op mechanics

## 🖥️ Work Experience:
- Completed **3 software engineering internships at Google**
- Worked on **LLM and AI-powered features for Google Search**
- Built workflows converting Search and shopping data into **JSON** for machine learning systems
- Developed internal tools for **Retail Ads**, **AI**, and UX data preparation
- Built a node-based visual code authoring editor in **C++** using **ImGui** and **Protocol Buffers**
...
<div align="center">
  <a href="https://stickguy101.itch.io/purge-repurpose-destroy"><img src="Images/PRDPreviewGithub.gif" width = "420"> <a/>
  <a href="https://adamkaciportfolio.myportfolio.com/project-b"><img src="Images/ProjectB.gif" width = "420"> </a> </br>
